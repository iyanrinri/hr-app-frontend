import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, Suspense, mergeProps, Fragment, createVNode, resolveDynamicComponent, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/ufo/dist/index.mjs";
...
const layouts = {
  auth: defineAsyncComponent(() => import("./_nuxt/auth-DhtEnWEW.js").then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import("./_nuxt/dashboard-BCu4nyEL.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-AoSVxFnH.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CgJ1jAXL.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BIgCxgbS.js"));
...
export {
  ...
  BellOff as af,
  useNuxtApp as ag,
  resolveRouteObject as ah,
  useRuntimeConfig as ai,
  navigateTo as aj,
  nuxtLinkDefaults as ak,
  asyncDataDefaults as al,
  createError as am,
  fetchDefaults as an,
  useRequestFetch as ao,
  defineStore as ap,
  Filter as aq,
  LayoutDashboard as ar,
  CalendarClock as as,
  SquareCheckBig as at,
  Hourglass as au,
  ChevronLeft as av,
  Calendar as b,
  CircleCheckBig as c,
