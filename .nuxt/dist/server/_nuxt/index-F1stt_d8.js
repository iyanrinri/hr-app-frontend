...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><span class="text-lg font-bold text-gray-900">HR Portal</span></div><p class="text-gray-500 text-sm"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} HR Portal Internal System. All rights reserved. </p></div></footer></div>`);
    };
  }
});
...
//# sourceMappingURL=index-F1stt_d8.js.map
