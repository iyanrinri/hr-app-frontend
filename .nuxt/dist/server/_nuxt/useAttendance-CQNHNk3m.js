import { m as useNuxtApp, n as asyncDataDefaults, o as createError, p as fetchDefaults, u as useRoute } from "../server.mjs";
import { computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, toRef, nextTick, unref, reactive, watch } from "vue";
import { hash } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { u as useRequestFetch } from "./ssr-BF3tP62J.js";
import { debounce } from "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/perfect-debounce/dist/index.mjs";
...
const useTodayAttendance = () => {
  ...
  const { data, pending, error, refresh } = useFetch(() => getUrl("/attendance/today"), {
    ...
    // We can add retry logic or other options here
  }, "$_XterQpiXI");
  return {
    data,
    loading: pending,
...
const useAttendanceHistory = (page, limit, filters = {}) => {
  ...
  const queryParams = computed(() => ({
    page: unref(page),
    limit: unref(limit),
    startDate: unref(filters.startDate),
    endDate: unref(filters.endDate),
    employeeId: unref(filters.employeeId),
...
export {
  useClockIn as a,
  useClockOut as b,
  useAttendanceStats as c,
  useTodayAttendanceDashboard as d,
  useAttendanceHistory as e,
  useFetch as f,
  useTodayAttendance as u
};
//# sourceMappingURL=useAttendance-CQNHNk3m.js.map
