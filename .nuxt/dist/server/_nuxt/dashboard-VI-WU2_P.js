import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, resolveDynamicComponent, createBlock, createCommentVNode, openBlock, toDisplayString, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
import { _ as __nuxt_component_0 } from "./nuxt-link-BACLTvko.js";
import { u as useAuthStore } from "./auth-BV7LzjtB.js";
import { u as useNotificationStore } from "./notifications-CP0wUJbA.js";
import { u as useAuth } from "./useAuth-EKG63SvL.js";
import { u as useRoute, q as LayoutDashboard, l as Clock, j as Bell, a as Users, b as Calendar, S as Settings, r as CalendarClock, s as FileText, v as SquareCheckBig, w as ChartColumn, c as Timer, H as Hourglass, x as Banknote, W as Wallet, y as ChevronRight, z as ChevronLeft, e as LogOut } from "../server.mjs";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const authStore = useAuthStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6" }, _attrs))}><h1 class="text-lg font-semibold text-gray-800"> Welcome back, ${ssrInterpolate(unref(authStore).user?.name || "User")}</h1><div class="flex items-center space-x-4"><div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold">${ssrInterpolate((unref(authStore).user?.name?.charAt(0) || "U").toUpperCase())}</div></div></header>`);
    };
  }
});
...
//# sourceMappingURL=dashboard-VI-WU2_P.js.map
