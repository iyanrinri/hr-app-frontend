import { _ as _sfc_main$6 } from "./Button-gKFWS_xI.js";
import { _ as _sfc_main$7 } from "./Card-CVi1E1xp.js";
import { _ as _sfc_main$8, a as _sfc_main$9 } from "./CardTitle-D9AdQELc.js";
import { _ as _sfc_main$a } from "./CardContent-BE35Q-6Q.js";
import { _ as _sfc_main$b } from "./Input-CKYYc_rG.js";
import { defineComponent, ref, mergeProps, withCtx, createTextVNode, useSSRContext, unref, computed, createVNode, toDisplayString, createBlock, openBlock, withDirectives, Fragment, renderList, vModelSelect, watch, withModifiers, createCommentVNode } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
import { d as useEmployee, u as useAllEmployees, e as useAssignManager, f as useAssignSubordinates, g as useUpdateEmployee } from "./useEmployees-CEaIsP48.js";
import { f as useEmployeeProfile, g as useUpdateEmployeeProfile, h as useUploadEmployeePicture, i as useDeleteEmployeePicture, _ as _sfc_main$c, d as _sfc_main$d, e as _sfc_main$e } from "./ProfilePictureUpload-DFGwDs2u.js";
import "/Users/iyan/NodeStudio/hr-app-frontend/node_modules/hookable/dist/index.mjs";
import { U as User, a3 as Network, a as Users, a4 as UserPlus, u as useRoute, W as Wallet, b as Calendar, a5 as Award, a6 as History, D as DollarSign, n as useRouter, o as ArrowLeft } from "../server.mjs";
import "clsx";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiCardHeader = _sfc_main$8;
                    ...
                    if (isEditManager.value) {
                      ...
                      if (unref(employee).managerId) {
                        ...
                        if (getManagerName(unref(employee).managerId)) {
                          _push3(`<div${_scopeId2}><p class="font-medium text-gray-900"${_scopeId2}>${ssrInterpolate(getManagerName(unref(employee).managerId)?.firstName)} ${ssrInterpolate(getManagerName(unref(employee).managerId)?.lastName)}</p><p class="text-xs text-gray-500"${_scopeId2}>${ssrInterpolate(getManagerName(unref(employee).managerId)?.position)}</p></div>`);
                        } else {
                        ...
                        createVNode("div", null, [
                          unref(employee).managerId ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                            getManagerName(unref(employee).managerId) ? (openBlock(), createBlock("div", { key: 0 }, [
                              createVNode("p", { class: "font-medium text-gray-900" }, toDisplayString(getManagerName(unref(employee).managerId)?.firstName) + " " + toDisplayString(getManagerName(unref(employee).managerId)?.lastName), 1),
                              createVNode("p", { class: "text-xs text-gray-500" }, toDisplayString(getManagerName(unref(employee).managerId)?.position), 1)
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$5, {
                      ...
                      currentSubordinates: unref(allEmployees)?.filter((e) => String(e.managerId) === String(__props.employeeId)) || [],
      ...
      if (unref(isLoadingEmployee) && !unref(employee)) {
                    ...
                    if (_push3) {
                      if (unref(isLoadingProfile)) {
                        ...
                        if (isEditingProfile.value) {
                          ...
                          _push3(ssrRenderComponent(_sfc_main$e, { profile: unref(profile) }, null, _parent3, _scopeId2));
                        }
                        _push3(`</div>`);
                      }
                    } else {
                      return [
                        unref(isLoadingProfile) ? (openBlock(), createBlock("div", {
                          ...
                          isEditingProfile.value ? (openBlock(), createBlock(_sfc_main$d, {
                            key: 0,
                            initialData: unref(profile),
                            onSubmit: handleUpdateProfile,
                            onCancel: ($event) => isEditingProfile.value = false,
                            isLoading: unref(isUpdatingProfile),
                            isAdmin: true
                          }, null, 8, ["initialData", "onCancel", "isLoading"])) : (openBlock(), createBlock(_sfc_main$e, {
                            key: 1,
        ...
        if (activeTab.value === "salary") {
          ...
          _push(ssrRenderComponent(_sfc_main$1, {
            employeeId: unref(id),
            currentBaseSalary: unref(employee)?.baseSalary
          }, null, _parent));
          _push(`</div>`);
        } else {
          _push(`<!---->`);
...
//# sourceMappingURL=index-DupTBXSg.js.map
