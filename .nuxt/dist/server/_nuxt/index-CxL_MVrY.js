...
import { u as useMyProfile, a as useUpdateMyProfile, b as useUploadMyProfilePicture, c as useDeleteMyProfilePicture, _ as _sfc_main$1, d as _sfc_main$2, e as _sfc_main$3 } from "./ProfilePictureUpload-DFGwDs2u.js";
...
import "./Input-CKYYc_rG.js";
import "./index-B7s_3MI_.js";
import "clsx";
import "tailwind-merge";
import "./Button-gKFWS_xI.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(isLoading) || !unref(profile)) {
        ...
        _push(` ${ssrInterpolate(unref(profile).user?.role || unref(profile).role)}</span><span class="flex items-center bg-gray-100 px-3 py-1 rounded-full border border-gray-200 text-gray-700">`);
        _push(ssrRenderComponent(unref(Mail), { class: "w-3.5 h-3.5 mr-2 text-brand-navy" }, null, _parent));
        _push(` ${ssrInterpolate(unref(profile).user?.email || unref(profile).email)}</span><span class="flex items-center bg-gray-100 px-3 py-1 rounded-full border border-gray-200 text-gray-700">`);
        ...
        if (isEditing.value) {
          ...
          _push(ssrRenderComponent(_sfc_main$3, { profile: unref(profile) }, null, _parent));
        }
        _push(`</div></div>`);
      }
    };
...
//# sourceMappingURL=index-CxL_MVrY.js.map
