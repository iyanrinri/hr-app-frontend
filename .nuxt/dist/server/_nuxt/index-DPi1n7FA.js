...
import { defineComponent, computed, ref, mergeProps, unref, withCtx, createTextVNode, useSSRContext, createVNode } from "vue";
...
import { u as useActiveLeavePeriod, a as useLeaveTypes, b as useCreateLeaveRequest, c as useMyLeaveBalances, d as useMyLeaveRequests, e as useCancelLeaveRequest } from "./useLeaves-DMmgn55L.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(activePeriod)) {
        ...
        ssrRenderList(unref(leaveTypes)?.filter((t) => t.isActive), (type) => {
...
//# sourceMappingURL=index-DPi1n7FA.js.map
