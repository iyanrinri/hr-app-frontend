...
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, resolveDynamicComponent, watch, withDirectives, vModelText, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, useSSRContext } from 'vue';
...
import { i as Download, R as RefreshCw, P as Plus, j as ChevronDown, W as Wallet, e as Banknote, f as Clock, g as TrendingDown, c as CircleCheckBig, u as useRoute, b as Calendar, E as Eye, D as DollarSign, d as Trash2, F as FileText, X, h as CircleX } from './server.mjs';
import { TransitionRoot, Dialog, TransitionChild, DialogPanel, DialogTitle } from '@headlessui/vue';
import { u as usePayrolls, a as usePayrollSummary, b as useProcessPayrolls, c as useMarkPayrollPaid, d as useDeletePayroll, e as useBulkGeneratePayroll } from './usePayroll-BqsCAGPe.mjs';
import { u as useGeneratePayslip } from './usePayslips-toysh2Fm.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.isLoading) {
        ...
        ssrRenderList(__props.payrolls, (payroll) => {
          var _a, _b, _c;
          _push(`<tr class="hover:bg-gray-50"><td class="px-6 py-4 whitespace-nowrap"><div class="flex items-center"><div class="text-sm font-medium text-gray-900">${ssrInterpolate((_a = payroll.employee) == null ? void 0 : _a.firstName)} ${ssrInterpolate((_b = payroll.employee) == null ? void 0 : _b.lastName)}</div></div><div class="text-xs text-gray-500">${ssrInterpolate((_c = payroll.employee) == null ? void 0 : _c.position)}</div></td><td class="px-6 py-4 whitespace-nowrap"><div class="flex items-center text-sm text-gray-500">`);
  ...
  setup(__props) {
    ...
    const handleGeneratePayslip = async (id) => {
      if (confirm("Generate payslip for this payroll?")) {
        await generatePayslip({ payrollId: id }, {
          onSuccess: () => refreshAll(),
          onError: (err) => {
            if ((err == null ? void 0 : err.statusCode) === 400) alert("Payslip already exists");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$4, {
        payrolls: ((_a = unref(payrollsData)) == null ? void 0 : _a.data) || [],
...
//# sourceMappingURL=index-DbnmJ9nl.mjs.map
