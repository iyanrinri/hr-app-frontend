import { defineComponent, ref, mergeProps, createVNode, resolveDynamicComponent, unref, computed, watch, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrRenderVNode, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderAttr, ssrRenderDynamicModel } from 'vue/server-renderer';
import { s as Settings, B as Building2, b as Calendar, v as Bell, S as Shield, p as LoaderCircle, u as useRoute, q as Save, r as __nuxt_component_0$1 } from './server.mjs';
import { r as refreshNuxtData, u as useFetch } from './fetch-VuP8VKdC.mjs';
      ...
      if (unref(loading)) {
        ...
        if (showMap.value) {
          ...
          _push(ssrRenderComponent(_sfc_main$2, {
            latitude: parseFloat(String(((_a = latSetting.value) == null ? void 0 : _a.value) || "0")),
            longitude: parseFloat(String(((_b = lngSetting.value) == null ? void 0 : _b.value) || "0")),
            radius: parseFloat(String(((_c = radiusSetting.value) == null ? void 0 : _c.value) || "100")),
            onLocationSelect
          }, null, _parent));
          _push(`</div></div>`);
        } else {
...
//# sourceMappingURL=index-yZIXBZ0Y.mjs.map
