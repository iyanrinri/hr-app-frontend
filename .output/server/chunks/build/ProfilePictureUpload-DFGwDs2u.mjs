import { p as LoaderCircle, aa as Camera, U as User, ab as CloudUpload, d as Trash2, X, q as Save, b as Calendar, a7 as Heart, a8 as CreditCard, a9 as Phone, Y as MapPin, H as Briefcase, l as BadgeCheck, B as Building2, u as useRoute } from './server.mjs';
import { u as useFetch } from './fetch-VuP8VKdC.mjs';
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, createTextVNode, createBlock, openBlock, Fragment, watch, toDisplayString, resolveDynamicComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrInterpolate, ssrRenderVNode } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        icon: unref(User),
        label: "Gender",
        value: ((_a = __props.profile.gender) == null ? void 0 : _a.replace("_", " ")) || "-"
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$3, {
        icon: unref(Heart),
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        icon: unref(Briefcase),
        label: "Position",
        value: __props.profile.position || ((_c = (_b = __props.profile) == null ? void 0 : _b.user) == null ? void 0 : _c.role)
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$3, {
...
export { _sfc_main as _, useUpdateMyProfile as a, useUploadMyProfilePicture as b, useDeleteMyProfilePicture as c, _sfc_main$1 as d, _sfc_main$2 as e, useEmployeeProfile as f, useUpdateEmployeeProfile as g, useUploadEmployeePicture as h, useDeleteEmployeePicture as i, useMyProfile as u };
//# sourceMappingURL=ProfilePictureUpload-DFGwDs2u.mjs.map
