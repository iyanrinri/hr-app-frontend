import { defineComponent, computed, mergeProps, unref, ref, createVNode, resolveDynamicComponent, withCtx, createTextVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderVNode, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
import { c as usePayslip, d as useDeletePayslip } from './usePayslips-toysh2Fm.mjs';
import { u as useRoute, n as useRouter, K as useAuthStore, d as Trash2, a1 as Printer, i as Download, a2 as ChevronUp, j as ChevronDown } from './server.mjs';
import { f as formatCurrency, t as terbilang } from './index-B7s_3MI_.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` Download PDF </button></div></div><div class="p-8 print:p-0"><div class="text-center mb-8 border-b-2 border-gray-800 pb-4"><h2 class="text-2xl font-bold uppercase tracking-wide">Slip Gaji / Payslip</h2><p class="text-gray-600">Company Name Inc.</p><div class="mt-2 text-sm text-gray-500"> Periode: ${ssrInterpolate(((_a = __props.payslip.payroll) == null ? void 0 : _a.periodStart) ? new Date(__props.payslip.payroll.periodStart).toLocaleDateString("id-ID", { month: "long", year: "numeric" }) : "N/A")}</div><div class="text-xs text-gray-400 mt-1"> Generated: ${ssrInterpolate(new Date(__props.payslip.generatedAt).toLocaleString())}</div></div><div class="grid grid-cols-2 gap-4 mb-8"><div><table class="w-full text-sm"><tbody><tr><td class="text-gray-500 py-1" width="100">Name</td><td class="font-semibold">: ${ssrInterpolate(((_c = (_b = __props.payslip.payroll) == null ? void 0 : _b.employee) == null ? void 0 : _c.firstName) || "-")} ${ssrInterpolate(((_e = (_d = __props.payslip.payroll) == null ? void 0 : _d.employee) == null ? void 0 : _e.lastName) || "")}</td></tr><tr><td class="text-gray-500 py-1">Position</td><td class="font-semibold">: ${ssrInterpolate(((_g = (_f = __props.payslip.payroll) == null ? void 0 : _f.employee) == null ? void 0 : _g.position) || "-")}</td></tr><tr><td class="text-gray-500 py-1">Department</td><td class="font-semibold">: ${ssrInterpolate(((_i = (_h = __props.payslip.payroll) == null ? void 0 : _h.employee) == null ? void 0 : _i.department) || "-")}</td></tr></tbody></table></div><div><table class="w-full text-sm"><tbody><tr><td class="text-gray-500 py-1" width="100">Status PTKP</td><td class="font-semibold">: ${ssrInterpolate(((_j = __props.payslip.taxCalculationDetails) == null ? void 0 : _j.ptkpCategory) || "-")}</td></tr><tr><td class="text-gray-500 py-1">Payment Date</td><td class="font-semibold">: ${ssrInterpolate(((_k = __props.payslip.payroll) == null ? void 0 : _k.processedAt) ? new Date(__props.payslip.payroll.processedAt).toLocaleDateString() : "-")}</td></tr></tbody></table></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8"><div><h3 class="text-sm font-bold uppercase text-gray-500 mb-3 border-b border-gray-200 pb-1">Penghasilan / Income</h3><table class="w-full text-sm"><tbody><tr><td class="py-1">Gaji Pokok</td><td class="text-right font-medium">${ssrInterpolate(unref(formatCurrency)(__props.payslip.grossSalary))}</td></tr><tr><td class="py-1">Lembur ${ssrInterpolate(((_l = __props.payslip.payroll) == null ? void 0 : _l.overtimeHours) ? `(${__props.payslip.payroll.overtimeHours} jam)` : "")}</td><td class="text-right font-medium">${ssrInterpolate(unref(formatCurrency)(__props.payslip.overtimePay))}</td></tr><tr><td class="py-1">Allowance / Tunjangan</td><td class="text-right font-medium">${ssrInterpolate(unref(formatCurrency)(__props.payslip.allowances))}</td></tr><tr><td class="py-1">Bonus</td><td class="text-right font-medium">${ssrInterpolate(unref(formatCurrency)(__props.payslip.bonuses))}</td></tr><tr class="border-t border-gray-300 font-bold mt-2"><td class="pt-2">Total Penghasilan Kotor</td><td class="text-right pt-2">${ssrInterpolate(unref(formatCurrency)(totalGross.value))}</td></tr></tbody></table></div><div><h3 class="text-sm font-bold uppercase text-gray-500 mb-3 border-b border-gray-200 pb-1">Potongan / Deductions</h3><table class="w-full text-sm"><tbody><!--[-->`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isAdmin = computed(() => {
      var _a;
      return ["ADMIN", "SUPER", "HR"].includes(((_a = user.value) == null ? void 0 : _a.role) || "");
    });
...
//# sourceMappingURL=index-TmyR3Kn9.mjs.map
