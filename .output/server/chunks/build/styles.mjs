...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BOpXmk11.mjs').then(interopDefault),
  ...
  "components/settings/AttendanceMap.vue?vue&type=script&setup=true&lang.ts": () => import('./AttendanceMap-styles.BydL4Ul1.mjs').then(interopDefault)
};
