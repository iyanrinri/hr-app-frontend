...
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, watch, useSSRContext } from 'vue';
...
import { c as useActiveLeavePeriod, d as useLeaveTypes, f as useEmployeeLeaveBalances } from './useLeaves-DMmgn55L.mjs';
import { format } from 'date-fns';
import { _ as _sfc_main$3 } from './Input-CKYYc_rG.mjs';
import { b as Calendar, y as Search, P as Plus, H as Briefcase, w as SquarePen } from './server.mjs';
  ...
  setup(__props) {
    ...
    const filteredEmployees = computed(() => {
      ...
      return employees.value.filter((emp) => {
        ...
        const position = ((_a = emp.position) == null ? void 0 : _a.toLowerCase()) || "";
    ...
    const selectedEmployee = computed(
      () => {
        var _a;
        return (_a = employees.value) == null ? void 0 : _a.find((emp) => String(emp.id) === selectedEmployeeId.value);
      }
    );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!selectedEmployeeId.value) {
        ...
        _push(`<div class="space-y-6"><div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6"><div class="flex items-center justify-between"><div class="flex items-center gap-4"><div class="h-12 w-12 rounded-full bg-brand-navy flex items-center justify-center text-white"><span class="text-lg font-bold">${ssrInterpolate((_a = selectedEmployee.value) == null ? void 0 : _a.firstName.charAt(0))}${ssrInterpolate((_b = selectedEmployee.value) == null ? void 0 : _b.lastName.charAt(0))}</span></div><div><h3 class="text-lg font-semibold text-gray-900">${ssrInterpolate((_c = selectedEmployee.value) == null ? void 0 : _c.firstName)} ${ssrInterpolate((_d = selectedEmployee.value) == null ? void 0 : _d.lastName)}</h3><p class="text-sm text-gray-500">${ssrInterpolate((_e = selectedEmployee.value) == null ? void 0 : _e.position)}</p></div></div>`);
        _push(ssrRenderComponent(_component_UiButton, {
...
//# sourceMappingURL=index-BUsqknlQ.mjs.map
