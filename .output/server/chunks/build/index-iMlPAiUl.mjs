...
import { defineComponent, computed, mergeProps, unref, withCtx, createTextVNode, createVNode, ref, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, renderSlot, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderSlot } from 'vue/server-renderer';
import { u as useRoute, K as useAuthStore, aq as Filter, b as Calendar, E as Eye, X } from './server.mjs';
import { _ as _sfc_main$6 } from './Card-CVi1E1xp.mjs';
import { _ as _sfc_main$7 } from './CardContent-BE35Q-6Q.mjs';
import { _ as _sfc_main$9 } from './Input-CKYYc_rG.mjs';
import { c as cn } from './index-B7s_3MI_.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$a } from './CardTitle-D9AdQELc.mjs';
import { TransitionRoot, Dialog, TransitionChild, DialogPanel, DialogTitle, DialogDescription } from '@headlessui/vue';
import { e as useAttendanceHistory } from './useAttendance-DJVfF5IK.mjs';
import { _ as _sfc_main$8 } from './EmployeeSelector-DR-a5UsR.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const totalPages = computed(() => {
      var _a, _b;
      return ((_b = (_a = response.value) == null ? void 0 : _a.meta) == null ? void 0 : _b.totalPages) || 0;
    });
    const applyFilters = () => {
                ...
                if (_push3) {
                  ...
                  return [
                    createVNode("div", { class: "space-y-4" }, [
                      __props.isAdmin ? (openBlock(), createBlock(_sfc_main$8, {
                        key: 0,
                        modelValue: filters.value.employeeId,
                        "onUpdate:modelValue": ($event) => filters.value.employeeId = $event,
                        class: "max-w-md"
                ...
                if (_push3) {
                  if (unref(loading)) {
                    ...
                    ssrRenderList(attendanceRecords.value, (record) => {
                      ...
                      if (__props.isAdmin) {
                        _push3(`<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"${_scopeId2}>${ssrInterpolate((_a = record.employee) == null ? void 0 : _a.firstName)} ${ssrInterpolate((_b = record.employee) == null ? void 0 : _b.lastName)}</td>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      ...
                      createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(attendanceRecords.value, (record) => {
                          ...
                          return openBlock(), createBlock("tr", {
                            ...
                            }, toDisplayString((_a = record.employee) == null ? void 0 : _a.firstName) + " " + toDisplayString((_b = record.employee) == null ? void 0 : _b.lastName), 1)) : createCommentVNode("", true),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isAdmin = computed(() => {
      var _a;
      return ["ADMIN", "HR", "SUPER"].includes(((_a = authStore.user) == null ? void 0 : _a.role) || "");
    });
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=index-iMlPAiUl.mjs.map
