import { _ as _sfc_main$1 } from './Input-BiMdQ6SY.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></form><p class="text-center text-xs text-gray-400 mt-8"> \xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} HR Portal by NodeStudio. All rights reserved. </p></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=find-workspace-Db6kef9C.mjs.map
