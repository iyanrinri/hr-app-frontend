...
import { _ as _sfc_main$1 } from './Button-DjJ57WMA.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$2 } from './CardContent-BenvirN4.mjs';
import { _ as _sfc_main$4 } from './Input-BiMdQ6SY.mjs';
import { _ as _sfc_main$1$2, a as _sfc_main$5 } from './CardTitle--sGWBRLF.mjs';
...
import { u as useAuthStore } from './auth-BV7LzjtB.mjs';
import { e as useAttendanceHistory } from './useAttendance-CQNHNk3m.mjs';
import { _ as _sfc_main$3 } from './EmployeeSelector-D0f4uo7f.mjs';
            ...
            _push2(ssrRenderComponent(_component_UiCardContent, { class: "pt-6" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  if (((_a2 = user.value) == null ? void 0 : _a2.role) === "HR" || ((_b = user.value) == null ? void 0 : _b.role) === "SUPER" || ((_c = user.value) == null ? void 0 : _c.role) === "ADMIN") {
                  ...
                  return [
                    createVNode("div", { class: "space-y-4" }, [
                      ((_d = user.value) == null ? void 0 : _d.role) === "HR" || ((_e = user.value) == null ? void 0 : _e.role) === "SUPER" || ((_f = user.value) == null ? void 0 : _f.role) === "ADMIN" ? (openBlock(), createBlock(_sfc_main$3, {
                        key: 0,
                        modelValue: selectedEmployeeId.value,
                        "onUpdate:modelValue": ($event) => selectedEmployeeId.value = $event
            ...
            return [
              createVNode(_component_UiCardContent, { class: "pt-6" }, {
                default: withCtx(() => {
                  ...
                  return [
                    createVNode("div", { class: "space-y-4" }, [
                      ((_a2 = user.value) == null ? void 0 : _a2.role) === "HR" || ((_b = user.value) == null ? void 0 : _b.role) === "SUPER" || ((_c = user.value) == null ? void 0 : _c.role) === "ADMIN" ? (openBlock(), createBlock(_sfc_main$3, {
                        key: 0,
                        modelValue: selectedEmployeeId.value,
                        "onUpdate:modelValue": ($event) => selectedEmployeeId.value = $event
                      }, null, 8, ["modelValue", "onUpdate:modelValue"])) : createCommentVNode("", true),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if (unref(loading)) {
                    ...
                    if (!((_d = unref(response)) == null ? void 0 : _d.data) || unref(response).data.length === 0) {
                      _push3(`<tr${_scopeId2}><td colspan="8" class="px-6 py-8 text-center text-gray-500"${_scopeId2}> No attendance records found </td></tr>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<!--[-->`);
                    ssrRenderList((_e = unref(response)) == null ? void 0 : _e.data, (attendance) => {
                      ...
                      if (((_a3 = user.value) == null ? void 0 : _a3.role) === "HR" || ((_b2 = user.value) == null ? void 0 : _b2.role) === "SUPER" || ((_c2 = user.value) == null ? void 0 : _c2.role) === "ADMIN") {
                        _push3(`<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"${_scopeId2}>${ssrInterpolate((_d2 = attendance.employee) == null ? void 0 : _d2.firstName)} ${ssrInterpolate((_e2 = attendance.employee) == null ? void 0 : _e2.lastName)}</td>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    ...
                    unref(loading) ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("thead", { class: "bg-gray-50" }, [
                        createVNode("tr", null, [
                          ...
                          ((_f = user.value) == null ? void 0 : _f.role) === "HR" || ((_g = user.value) == null ? void 0 : _g.role) === "SUPER" || ((_h = user.value) == null ? void 0 : _h.role) === "ADMIN" ? (openBlock(), createBlock("th", {
                            key: 0,
                      ...
                      createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                        !((_i = unref(response)) == null ? void 0 : _i.data) || unref(response).data.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                          createVNode("td", {
                            colspan: "8",
                            class: "px-6 py-8 text-center text-gray-500"
                          }, " No attendance records found ")
                        ])) : createCommentVNode("", true),
                        (openBlock(true), createBlock(Fragment, null, renderList((_j = unref(response)) == null ? void 0 : _j.data, (attendance) => {
                          var _a3, _b2, _c2, _d2, _e2;
                          return openBlock(), createBlock("tr", {
                            ...
                            ((_a3 = user.value) == null ? void 0 : _a3.role) === "HR" || ((_b2 = user.value) == null ? void 0 : _b2.role) === "SUPER" || ((_c2 = user.value) == null ? void 0 : _c2.role) === "ADMIN" ? (openBlock(), createBlock("td", {
                              key: 0,
                              class: "px-6 py-4 whitespace-nowrap text-sm text-gray-900"
                            }, toDisplayString((_d2 = attendance.employee) == null ? void 0 : _d2.firstName) + " " + toDisplayString((_e2 = attendance.employee) == null ? void 0 : _e2.lastName), 1)) : createCommentVNode("", true),
                  ...
                  return [
                    unref(loading) ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("thead", { class: "bg-gray-50" }, [
                        createVNode("tr", null, [
                          createVNode("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Date"),
                          ((_a2 = user.value) == null ? void 0 : _a2.role) === "HR" || ((_b = user.value) == null ? void 0 : _b.role) === "SUPER" || ((_c = user.value) == null ? void 0 : _c.role) === "ADMIN" ? (openBlock(), createBlock("th", {
                            key: 0,
                            class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                          }, "Employee")) : createCommentVNode("", true),
                          createVNode("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Clock In"),
                      ...
                      createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                        !((_d = unref(response)) == null ? void 0 : _d.data) || unref(response).data.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                          createVNode("td", {
                            colspan: "8",
                            class: "px-6 py-8 text-center text-gray-500"
                          }, " No attendance records found ")
                        ])) : createCommentVNode("", true),
                        (openBlock(true), createBlock(Fragment, null, renderList((_e = unref(response)) == null ? void 0 : _e.data, (attendance) => {
                          var _a3, _b2, _c2, _d2, _e2;
                          return openBlock(), createBlock("tr", {
                            key: attendance.id,
                            class: "hover:bg-gray-50"
...
//# sourceMappingURL=index-B8-o_fFW.mjs.map
